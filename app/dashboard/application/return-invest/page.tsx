...
export default function InternationalAccountPage() {
   ...
   const getValidationSchema = (hasServices: boolean) => {
      ...
      // ✅ Full validation (your original one)
      return Yup.object({
         service_type: Yup.string().required("Account type is required"),
      ...
      <div className="space-y-2">
         <div className="text-center py-8 rounded-lg space-y-2">
            ...
            <p className="text-sm text-muted-foreground max-w-2xl mx-auto">
               Complete your personal information to open new invest account on Phajaoinvest.
            </p>
         </div>
                           ...
                           <div className="grid md:grid-cols-2 gap-4">
                              <div className="space-y-1">
                                 <Label htmlFor="identity_front">
                                    Identity Front Side Copy <span className="text-rose-500">*</span>
                                 </Label>
                                 <Input
                                    id="identity_front"
                                    type="file"
                                 ...
                                 <p className="text-xs text-muted-foreground mt-1">
                                    Upload a clear copy of your Identity front side (PDF, JPG, PNG)
                                 </p>
                              ...
                              <div className="space-y-1">
                                 ...
                                 />
                                 <p className="text-xs text-muted-foreground mt-1">
                                    Upload a clear copy of your identity back side  (PDF, JPG, PNG)
                                 </p>
